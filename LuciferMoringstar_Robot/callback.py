...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            await query.answer("""» HERE IS THE SOLUTION «\n\n🧾 Send Me Rs. 50/- Per Month With Payment Proof\n\nUPI 🆔 Details\n\n\nGPay 📲 chester.anjan@oksbi\nPhonePe 📲 anjanmodak@ybl\n\n✅ After Payment Verification Your Id Will Be Freed""", show_alert=True)
            ...
            try:            
                if AUTH_CHANNEL and not await is_subscribed(client, query):
                    ...
                    buttons=[[
                     IineKeyboardButton("🆘👤 Owner", url="http://t.me/helloheartbeat"),
