...
from keys import API_ID, API_HASH, BOT_TOKEN, BOT_PHOTO, AUTOFILTER_DB, ANOTHER_DB, ADMINS, CHANNELS, AUTH_GROUPS, FORCES_SUB, LOG_CHANNEL, SEPLLING_MODE_ON_OR_OFF, SPELLING_MODE_TEXT, IMDB_POSTER_ON_OFF, LONG_IMDB_DESCRIPTION, CUSTOM_FILE_CAPTION,
